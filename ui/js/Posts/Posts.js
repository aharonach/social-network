...
class Posts extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(NewPost, {
      token: this.props.token,
      update: this.fetch_and_update
    }), /*#__PURE__*/React.createElement("div", {
      className: "cards"
    }, this.props.list.map(item => /*#__PURE__*/React.createElement(Post, {
      post: item,
      key: item.id
    }))));
  }
